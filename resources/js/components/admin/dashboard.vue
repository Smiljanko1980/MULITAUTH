<template>
  <div>
    ...
    <section class="content" style="border: 2px solid black">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3>{{printCategoryInform.length}}</h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <router-link to="/author" class="small-box-footer">
                More info
                <i class="fa fa-arrow-circle-right"></i>
              </router-link>
            </div>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3>{{printMyBorrowBook_date_return.length}}</h3>
                <p>Total Borrow</p>
              </div>
              <div class="icon">
                <i class="ion ion-pie-graph"></i>
              </div>
              <router-link to="/borrows" class="small-box-footer">
                More info
                <i class="fa fa-arrow-circle-right"></i>
              </router-link>
            </div>
