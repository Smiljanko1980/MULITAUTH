              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <tbody>
                  <tr v-for="(result,index) in printMyUser">
                    ...
                    <td>{{(result.role === 'admin') ? 'admin' : 'user'}}</td>

                    <td>
                      <router-link :to="`/user-edit/${result.id}`" class="btn btn-info" href>Edit</router-link>
                      <a @click.prevent="User(result.id)" class="btn btn-info" href>Delete</a>
                    </td>
                  </tr>
                </tbody>
                <tfoot>
